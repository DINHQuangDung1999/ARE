...
class Quadruped(WarpEnv):
    ...
    def create_articulation(self, builder):
        wp.sim.parse_urdf(
            os.path.join(self.asset_dir, "dflex/quadruped.urdf"),
            builder,
        ...
        builder.joint_q[7:] = [0.2, 0.4, -0.6, -0.2, -0.4, 0.6, -0.2, 0.4, -0.6, 0.2, -0.4, 0.6]
        builder.joint_q[:7] = [0.0, 0.0, 0.0, *wp.quat_from_axis_angle(wp.vec3(1.0, 0.0, 0.0), -math.pi * 0.5)]
        builder.joint_q[1] = 0.6  # start_height
...
if __name__ == "__main__":
    run_env(Quadruped,  episode_length=500, early_termination=False)
